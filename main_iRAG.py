...
if __name__ == '__main__':
    ...
    parser.add_argument('--object_detector', default='facebook/detr-resnet-50', help='Select the object detector model for video segmentation')
    parser.add_argument('--object_detector_device', choices=['cuda', 'cpu'], default='cuda', help='Select the device: cuda or cpu')
